...
q3eATE <- mean(smokers_predict) - mean(nonsmokers_predict)

#Next get ATT
q3eATT <- mean(smokers$dbrwt - smokers_predict)
...
#get overall mean - correct this
q4eATE <- weighted.mean(test_data$dbrwt[test_data$tobacco == 1], w = weights[test_data$tobacco == 1])- weighted.mean(test_data$dbrwt[test_data$tobacco == 0], w = weights[test_data$tobacco == 0])

#Next get ATT
q4eATT <- mean(smokers$dbrwt - smokers_predict)
```
